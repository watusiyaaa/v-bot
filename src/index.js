...
user.on(Events.MessageReactionAdd, async (react, user) => {
    ...
    .setThumbnail(user.displayAvatarURL({ extension: 'png', size: 512 }) ?? 'https://media.discordapp.net/attachments/1335172660182646927/1340632959467651122/discordgrey.png?ex=67b3113d&is=67b1bfbd&hm=e0e9ca814279a29237790ddb721a70821a470cb8256d81984fb9fd833d82182f&=&format=webp&quality=lossless&width=320&height=320')
