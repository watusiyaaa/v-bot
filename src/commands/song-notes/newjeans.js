    ...
    const pages = [
      {
        ...
        thumbnail:
          "https://images-ext-1.discordapp.net/external/kmaIOhfJn9aEmSmY367bnsFHdcVWXD_I_xIUFPVP5Aw/https/i.scdn.co/image/ab67616d0000b2739d28fd01859073a3ae6ea209?format=webp&width=662&height=662",
        footer: "Page 1/5",
        fields: [
          {
            name: "**Attention | `lvl.14`**",
            value:
              "__Short notes:__ `402` __Short length:__ `1:10`\n__Full notes:__ `1090` __Full length:__ `2:59`",
          },
          {
            name: "**Hype Boy | `lvl.13`**",
            value:
              "__Short notes:__ `380` __Short length:__ `1:01`\n__Full notes:__ `1111` __Full length:__ `2:59`",
          },
          {
            name: "**Cookie | `lvl.14`**",
            value:
              "__Short notes:__ `422` __Short length:__ `1:19`\n__Full notes:__ `1482` __Full length:__ `3:56`",
          },
          {
            name: "**Hurt | `lvl.11`**",
            value:
              "__Short notes:__ `261` __Short length:__ `1:03`\n__Full notes:__ `842` __Full length:__ `2:58`",
          },
          {
            name: "**Hype Boy (2nd ver.) | `lvl.13`**",
            value:
              "__Short notes:__ `339` __Short length:__ `1:01`\n__Full notes:__ `1038` __Full length:__ `2:59`",
          },
        ],
      },
      {
        ...
        thumbnail:
          "https://images-ext-1.discordapp.net/external/inGPnswmWz2C9LgXMWQLxV5m6EViZ0EvL9rnKoswzYw/https/i.scdn.co/image/ab67616d0000b273d70036292d54f29e8b68ec01?format=webp&width=662&height=662",
        footer: "Page 2/5",
        fields: [
          {
            name: "**Ditto | `lvl.13`**",
            value:
              "__Short notes:__ `253` __Short length:__ `1:01`\n__Full notes:__ `1010` __Full length:__ `3:06`",
          },
          {
            name: "**OMG | `lvl.14`**",
            value:
              "__Short notes:__ `441` __Short length:__ `1:01`\n__Full notes:__ `1319` __Full length:__ `3:32`",
          },
        ],
      },
      {
        ...
        thumbnail:
          "https://images-ext-1.discordapp.net/external/VTU8077GwNIRZGJpHhNCdaspP61h6FPmVEztn3kEYLI/https/i.scdn.co/image/ab67616d0000b2730744690248ef3ba7b776ea7b?format=webp&width=662&height=662",
        footer: "Page 3/5",
        fields: [
          {
            name: "**Super Shy | `lvl.13`**",
            value:
              "__Short notes:__ `259` __Short length:__ `0:57`\n__Full notes:__ `967` __Full length:__ `2:34`",
          },
          {
            name: "**Cool With You | `lvl.14`**",
            value:
              "__Short notes:__ `313` __Short length:__ `1:01`\n__Full notes:__ `796` __Full length:__ `2:28`",
          },
          {
            name: "**ETA | `lvl.13`**",
            value:
              "__Short notes:__ `307` __Short length:__ `0:55`\n__Full notes:__ `983` __Full length:__ `2:31`",
          },
          {
            name: "**New Jeans | `lvl.12`**",
            value:
              "__Short notes:__ `248` __Short length:__ `0:57`\n__Full notes:__ `582` __Full length:__ `1:48`",
          },
          {
            name: "**ASAP | `lvl.14`**",
            value:
              "__Short notes:__ `254` __Short length:__ `0:58`\n__Full notes:__ `925` __Full length:__ `2:14`",
          },
          {
            name: "**Super Shy (2nd ver.) | `lvl.16`**",
            value:
              "__Short notes:__ `454` __Short length:__ `0:57`\n__Full notes:__ `1372` __Full length:__ `2:34`",
          },
          {
      ...
      },
      {
        title: "**How Sweet**",
        thumbnail:
          "https://media.discordapp.net/attachments/1153807568255340554/1243433669490642944/How_Sweet_album_cover.jpg?ex=67b56a58&is=67b418d8&hm=9e0dd533d394d33b7399f33c03913c3ded939d2733e26a874a392a2f1423ae66&=&format=webp&width=662&height=662",
        footer: "Page 5/5",
        fields: [
          {
            name: "**How Sweet | `lvl.15`**",
            value:
              "__Short notes:__ `602` __Short length:__ `1:19`\n__Full notes:__ `1700` __Full length:__ `3:39`",
          },
          {
            name: "**Bubble Gum | `lvl.12`**",
            value:
              "__Short notes:__ `302` __Short length:__ `1:09`\n__Full notes:__ `1039` __Full length:__ `3:20`",
          },
        ],
      },
    ];
